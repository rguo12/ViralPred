...
if __name__ == '__main__':
    ...
    kshell_df = pd.read_csv('E:\ViralPred\\weng_network\\pr_design_matrix_50.csv',header=None,index_col=0)
    ...
    for i in xrange(0,10):
        ...
        of = open('E:\\ViralPred\\weng_network\\clf_res\\pr_TH_'+str(int(TH))+'_'+clf+'.csv','ab')
        wrt = csv.writer(of)
        wrt.writerow([c1_precision,c1_recall,c1_f1,c2_precision,
                      c2_recall,c2_f1,weighted_prec,weighted_rec,weighted_f1])

        of.close()
    #time_of = open('E:\\ViralPred\\weng_network\\run_time\\centrality_clf_'+str(clf)+'_train_test.csv','ab')
