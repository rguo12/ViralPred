...
if __name__ == '__main__':
    ...
    for i in xrange(0,10):
        ...
        for tr_ind,ts_ind in kf:
            if clf == 'SVM':
                lr = LinearSVC(max_iter=500)
                # SVC(cache_size=10000,kernel='rbf',C=0.0001,probability=False)
            if clf == 'LR':
        ...
        #of = open('E:\\ViralPred\\weng_network\\clf_res\\weng_TH_'+str(int(TH))+'_'+clf+'.csv','ab')
        #wrt = csv.writer(of)
    ...
    time_of = open('E:\\ViralPred\\weng_network\\run_time\\weng_clf_'+str(clf)+'_train_test.csv','ab')
