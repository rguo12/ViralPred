...
if __name__ == '__main__':
    seismic_df = pd.read_csv('E:\\ViralPred\\weng_network\\seismic_pred_weng_30k.txt',index_col=0,header=None)
    ...
    for i in xrange(0,10):
        ...
        '''
        of = open('E:\\ViralPred\\weng_network\\clf_res\\seismic_clf_TH_'+str(int(TH))+'_'+clf+'.csv','ab')
        wrt = csv.writer(of)
        ...
        of.close()
        '''
    time_of = open('E:\\ViralPred\\weng_network\\run_time\\seismic_clf_'+str(clf)+'_train_test.csv','ab')
