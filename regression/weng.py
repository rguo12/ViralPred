...
if __name__ == '__main__':
    asonam_df = pd.read_csv('E:\ViralPred\\weibo_network\\weng_features_1.0.csv',index_col=0,header=None)
    ...
    print len(y)
    reg_of = open('E:\\ViralPred\\weibo_network\\reg_res\\wengS'+regressor+'.csv','ab')
    reg_wrt = csv.writer(reg_of)

    time_of = open('E:\\ViralPred\\weibo_network\\run_time\\wengS'+regressor+'.csv','ab')
