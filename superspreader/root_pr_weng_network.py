...
if __name__ == '__main__':
    ...
    kshell_df = pd.read_csv('E:\\ViralPred\\weng_network\\pagerank.csv',index_col=0,header=None,sep=',')
    ...
    print len(fs_df[1])
    print fs_df.head()
    fs_df[[1,3,4]].to_csv('E:\\ViralPred\\weng_network\\pr_design_matrix_50.csv',header=None,index=False)
