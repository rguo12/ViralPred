...
if __name__ == '__main__':
    ...
    #of = open('E:\\ViralPred\\weibo_network\\asonam_features_lambda'+str(THRESHOLD)+'.csv','wb')
    #wrt = csv.writer(of)

    time_of = open('E:\\ViralPred\\weibo_network\\run_time\\asonam_model.csv','ab')
